import { Briefcase, PiggyBank, Heart, Car, PawPrint, CheckCircle2, TrendingUp, Home, GraduationCap, LineChart } from "lucide-react";
...
export function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Garantiza que tus hijos o nietos estudien donde quieran",
      features: [
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#103595]/5 rounded-full mb-4">
            ...
            <span className="text-sm text-[#103595]">Productos y Servicios</span>
          </div>
          
          <h2 className="text-3xl md:text-4xl text-[#103595]" style={{ fontWeight: 600, letterSpacing: '-0.01em' }}>
            Soluciones a <span style={{ fontWeight: 800, color: '#ff6b0c' }}>tu medida</span>
          </h2>
          ...
          {services.slice(0, 3).map((service, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${service.gradient} opacity-0 group-hover:opacity-10 blur-2xl transition-opacity duration-300`}></div>
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    {IconAlt && (
                      <div className={`w-10 h-10 rounded-xl bg-gradient-to-br ${service.gradient} opacity-20 flex items-center justify-center`}>
              ...
              >
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {IconAlt2 && (
                      <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${service.gradient} opacity-15 flex items-center justify-center`}>
                        <IconAlt2 className="w-4 h-4 text-white" />
                      </div>
                    )}
                  </div>
